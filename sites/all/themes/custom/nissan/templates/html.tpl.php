...
<div id="load_screen"> <div id="loading"><img src="hechosdeemocion/node/sites/all/themes/custom/nissan/img/loading.gif" alt="loading"></div></div>

<script>
      window.fbAsyncInit = function() {
        FB.init({
          appId            : '368787816860268',
